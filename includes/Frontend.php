...
class Frontend
{
	...
	public static function checkUserAssign(): bool
	{
		$userAssign = in_array(
	...
	public static function get_user_mode(): bool
	{
	...
	public function user_assign_message_error(): void
	{
		$message = [
	...
	public function html($station, ...$args): void
	{
		echo '<!DOCTYPE html>';
		echo "\n";
		echo '<html>';
	...
	public function head($station): void
	{
	...
	public static function getPOSSettings($station): array
	{
		...
		return [
			...
			'LOCALE_PATH' => Plugin::isActive('pos-ui')
				...
				: '',
			'LOADING_BEHAVIOR' => $station->getData('pos_loading_behavior'),
			'PRODUCT_SYNC_INITIAL' => General::get_product_sync('initial'),
			'PRODUCT_SYNC_BACKGROUND' => General::get_product_sync('background'),
		];
	}

	private static function normalize_tabs_slug($tabs): array
	{
		$result = [];

...
class Activate
{
	...
	public function activationProcess(): void
	{
		...
		if (version_compare($version, '4.3.23', '<')) {
			$this->activationProcessV4_3_23();
		}
		if (version_compare($version, '4.5.0', '<')) {
			$this->activationProcessV4_5_0();
		}

		Plugin::setVersion(PLUGIN_VERSION);
	}

	protected function activationProcessV1(): void
	{
		$administrator = get_role('administrator');
		$administrator->add_cap('manage_woocommerce_pos');
	...
	protected function activationProcessV2()
	{
		$administrator = get_role('administrator');
	...
	protected function addBaseStations(): void
	{
		self::disable_cache();
	...
	protected function activationProcessV2_0_4(): void
	{
		$shop_manager = get_role('shop_manager');
		$shop_manager->add_cap('manage_woocommerce_pos');
	}

	protected function activationProcessV2_0_5(): void
	{
		$administrator = get_role('administrator');
		$shop_manager = get_role('shop_manager');
		$cashier = get_role('cashier');
	...
	protected function activationProcessV4_3_23(): void
	{
		$administrator = get_role('administrator');
		$shop_manager = get_role('shop_manager');
		$cashier = get_role('cashier');
		...
		$administrator->add_cap('search_private_shop_orders');
		$administrator->add_cap('search_match_private_shop_orders');
		$administrator->add_cap('edit_cart_product_price');
		$administrator->add_cap('search_list_users');
		$administrator->add_cap('search_match_list_users');

		$shop_manager->add_cap('search_private_shop_orders');
		$shop_manager->add_cap('search_match_private_shop_orders');
		$shop_manager->add_cap('edit_cart_product_price');
		$shop_manager->add_cap('search_list_users');
		$shop_manager->add_cap('search_match_list_users');

		$cashier->add_cap('search_match_private_shop_orders');
		$cashier->add_cap('edit_cart_product_price');
		$cashier->add_cap('search_list_users');
		$cashier->add_cap('search_match_list_users');

		$kiosk->add_cap('search_match_list_users');
	}

	protected function activationProcessV4_5_0(): void
	{
		$administrator = get_role('administrator');
		$shop_manager = get_role('shop_manager');
		$cashier = get_role('cashier');
		...
		$cashier->add_cap('manage_inventory');
	}

...
Tags: point of sale, point-of-sale, pos, in-person payments, Stripe Terminal
...
== Description ==
**Elevate your retail business with Jovvie Point of Sale POS**, the ultimate extension for your WooCommerce store. WooCommerce provides the shopping experience online and Jovvie syncs with WooCommerce to enable a full featured POS to sell anywhere in-person from any device.
...
== 5 Minute Easy Setup Video ==

In just a few clicks, a fully functional point of sale system will be seamlessly integrated into your WooCommerce store and ready to accept orders.

https://www.youtube.com/watch?v=ztXqfp5eTaU

If you're interested in a step-by-step walkthrough, check out our [Quick Start Guide](https://jovvie.com/quick-start-guide/pos-cloud/).

== Key Highlights of Jovvie POS ==

Explore our comprehensive Point of Sale walkthrough video.
...
== Changelog ==
= 5.2.2 =
* Hot fix to HPOS analytics
* Hot fix to empty orders behavior
* Misc bug fixes and performance improvements 
* WC tested up to 9.3.3
* WP tested up to 6.6.2

= 5.2.1 =
* WooCommerce Points and Rewards integration (https://woocommerce.com/products/woocommerce-points-and-rewards/)
* Hot fix to save order deleting of products
* Misc bug fixes and performance improvements 
* WC tested up to 9.3.3
* WP tested up to 6.6.2

= 5.1.0 =
* WooCommerce Gift Card support and integration (https://woocommerce.com/products/gift-cards/)
* Misc bug fixes and performance improvements 
* WC tested up to 9.3.1
* WP tested up to 6.6.2

= 5.0.5 =
* Optimizations for payment gateway activations and conflicts
* Misc bug fixes and performance improvements 
* WC tested up to 9.2.3
* WP tested up to 6.6.1

= 5.0.4 =
* Update to Stripe connect workflow
* Misc bug fixes and performance improvements 
* WC tested up to 9.2.3
* WP tested up to 6.6.1

= 5.0.3 =
* Added WooCommerce Subscription support: https://woocommerce.com/products/woocommerce-subscriptions/
* Misc bug fixes and performance improvements 
...
= 4.4.11 =
* Hot fix to coupon restrictions behavior
* WC tested up to 9.0.2
* WP tested up to 6.5.5

= 4.4.10 =
* Add customer field required setting
* Hot fix to shipping inputs
* WC tested up to 9.0.0
* WP tested up to 6.5.4

= 4.4.7 =
* Multi-inventory support hotfix for online order station
...
= 4.4.4 =
* Permission improvements for customer list, coupons and access
* Terminal readers setting selection on gateway
* Multi-inventory support optimizations
...
* Improvements to product variation sync
* Misc bug fixes and performance improvements 
* WC tested up to 8.8.2
* WP tested up to 6.5.2

= 4.3.14 =
* Gateway transaction fees functionality
* Stripe test mode
* Misc bug fixes and performance improvements 
...
= 4.3.8 =
* Add UA for API calls and URL
* Misc bug fixes and performance improvements 
* WC tested up to 8.7.0
* WP tested up to 6.5.0
...
= 4.2.15 =
* Cart behavior on $0 value order status mapping
* Added Stripe Terminal analytics
* Release update logic modification
* WC tested up to 8.7.0
...
= 4.2.11 =
* Background sync function in settings
* Fix save event for mobile behavior
* Stripe connect integration
* Remove Stripe Terminal add-on support
* Add product save event station settings
